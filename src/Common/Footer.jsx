  ...
  return (
    <div className="xl:container mx-auto ">
      <div className=' text-white relative'>
        <footer class="p-10 bg-[#046270] lg:h-[600px]  " style={{ backgroundImage: "url('https://example.com/your-image.jpg')" }} >
          <div class="grid grid-cols-1 md:grid-cols-5 gap-7 lg:ml-10   mt-10 ">
            <div className=''>
          ...
          <div class="mt-10 inline-block flex-col md:flex-row   items-center border-t w-full -ml-6 lg:-ml-4 border-white py-2 lg:py-6 ">

            <div className="bg-teal-700  text-white rounded-full mx-auto flex flex-col md:flex-row justify-between items-center p-4 md:p-8 lg:p-8 w-full max-w-5xl">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:justify-between w-full  mt-8 space-y-4 lg:space-y-0">
              {/* Copyright Section */}
